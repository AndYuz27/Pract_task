...
def save_txt(data, filename):
    ...
    with open(f"hello_{filename}.txt", "w", encoding="utf-8") as file:
        file.write("Select into")
        for  line in data:
            file.write(f"{line}\n")
    print('файл сохранен в TXT')
# save_txt()
...
if __name__ == '__main__':
    ...
    # url = 'https://www.wildberries.ru/catalog/igrushki/konstruktory-lego'
    # low_price = 800
    # top_price = 100000
